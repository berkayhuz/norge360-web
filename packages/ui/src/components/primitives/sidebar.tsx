...
import { Skeleton } from "@workspace/ui/components/layout/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
...
function useSidebar() {
  ...
  if (!context) {
    throw new Error("ui_sidebar_missing_provider")
  }
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>ui.sidebar.title</SheetTitle>
            <SheetDescription>ui.sidebar.description</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">ui.sidebar.toggle</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="ui.sidebar.toggleRail"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="ui.sidebar.toggleRail"
      className={cn(
