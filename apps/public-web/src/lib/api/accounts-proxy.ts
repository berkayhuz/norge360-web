...
const ACCOUNTS_ALLOWED_ROUTES: Array<{ method: string; pattern: RegExp }> = [
  ...
  { method: "GET", pattern: /^\/internal\/users\/resolve-by-profile\/[0-9a-fA-F-]{36}$/ },
  { method: "GET", pattern: /^\/internal\/users\/resolve-by-username\/[A-Za-z0-9_.-]{1,64}$/ },
  ...
  { method: "POST", pattern: /^\/reports\/[A-Za-z0-9_.-]{1,64}$/ },
